...
const Input = () => {
    ...
    return (
        ...
        <div className="InputValues"> <h3>Input Values:</h3> <div>{InputValues ? (<table className="InputValuesTable"> <tr> <th>I1</th> <th>I2</th> <th>I3</th> </tr> {displayInputValues()}</table>) : (<p>NONE</p>)}</div> </div>
